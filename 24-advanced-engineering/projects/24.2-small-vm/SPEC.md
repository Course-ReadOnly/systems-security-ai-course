...
# Project 24.2 — A Small VM

## Goal

A bytecode virtual machine — the natural compilation target for 24.1's
...
2. Correct call-stack handling: function calls push a new frame,
   ...
   values.
3. **Integrate with 24.1**: your compiler should be able to target this
...
- [ ] Paste a hand-assembled (or 24.1-compiled) bytecode program with
...
- [ ] If integrated with 24.1: paste a full pipeline run — source →
