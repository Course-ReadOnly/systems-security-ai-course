...
direct rehearsal for Stage 23's deeper AI×security integration.
...
| # | Project | Folder |
|---|---|---|
| 22.1 | Reverse-engineering assistant | `projects/22.1-re-assistant/` |
| 22.2 | Malware report summarizer | `projects/22.2-report-summarizer/` |
| 22.3 | Threat-hunting assistant | `projects/22.3-threat-hunting-assistant/` |
| 22.4 | Vulnerability assistant | `projects/22.4-vulnerability-assistant/` |

All four are "LLM applied to a domain from an earlier stage" projects —
do Karpathy's build-GPT material first so the tools you build in 22.1-
22.4 aren't just API calls to a black box.
