...
(gradients, backprop) and Stage 20's train/test discipline both get
...
3. Proper train/validation/test split — **validation set used for
   ...
   matters more here than in 20.1, since it's easier to overfit to a
